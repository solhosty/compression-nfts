import { PROGRAM_ID as BUBBLEGUM_PROGRAM_ID, TokenProgramVersion, createMintToCollectionV1Instruction } from "@metaplex-foundation/mpl-bubblegum"
...
async function createMerkle() { 
    ...
    for (let i = 0; i < numberOfTransactions; i++) {
        const stx = await sendVersionedTx(connection, [ix], keypair.publicKey, [keypair]);
