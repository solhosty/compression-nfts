...
import { createReplaceLeafInstruction, createAppendInstruction, createTransferAuthorityInstruction, createVerifyLeafInstruction, PROGRAM_ID, createInitEmptyMerkleTreeInstruction, createCloseEmptyTreeInstruction, } from '../generated';
/**
 * Helper function that adds proof nodes to a TransactionInstruction
 * by adding extra keys to the transaction
 */
export function addProof(instruction, nodeProof) {
 ...
 * @returns
 */
export function createInitEmptyMerkleTreeIx(merkleTree, authority, depthSizePair) {
 ...
 * @returns
 */
export function createReplaceIx(merkleTree, authority, newLeaf, proof) {
 ...
 * @returns
 */
export function createAppendIx(merkleTree, authority, newLeaf) {
 ...
 * @returns
 */
export function createTransferAuthorityIx(merkleTree, authority, newAuthority) {
 ...
 * @returns
 */
export function createVerifyLeafIx(merkleTree, proof) {
 ...
 * @returns
 */
export async function createAllocTreeIx(connection, merkleTree, payer, depthSizePair, canopyDepth) {
    const requiredSpace = getConcurrentMerkleTreeAccountSize(depthSizePair.maxDepth, depthSizePair.maxBufferSize, canopyDepth ?? 0);
 ...
 * @returns
 */
export function createCloseEmptyTreeIx(merkleTree, authority, recipient) {
