...
export class AmmV3 extends Base {
    ...
    // transaction
    static async makeCreatePoolInstructionSimple({ connection, programId, owner, mint1, mint2, ammConfig, initialPrice, startTime, computeBudgetConfig }) {
    ...
    static async makeCreatePoolInstructions({ connection, programId, owner, mintA, mintB, ammConfigId, initialPriceX64, startTime, }) {
        ...
        const instructions = [
            ...
            createPoolInstruction(programId, poolId, owner, ammConfigId, observationId.publicKey, mintA.mint, mintAVault, mintB.mint, mintBVault, initialPriceX64, startTime)
        ];
        return {
            address: {
