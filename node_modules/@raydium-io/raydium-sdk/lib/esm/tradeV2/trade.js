    ...
    static makeSwapInstruction({ routeProgram, ownerInfo, inputMint, swapInfo }) {
        if (swapInfo.routeType === 'amm') {
            ...
            return {
                ...
                innerTransaction: {
                    instructions: [
                        routeInstruction(routeProgram, ownerInfo.wallet, ownerInfo.sourceToken, ownerInfo.routeToken, ownerInfo.destinationToken, inputMint.toString(), swapInfo.middleMint.toString(), poolKey1, poolKey2, swapInfo.amountIn.raw, swapInfo.minAmountOut.raw, swapInfo.remainingAccounts)
                    ],
                    signers: [],
                    lookupTableAddress: [],
