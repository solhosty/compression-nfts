...
export declare const MIN_TICK = -307200;
export declare const MAX_TICK: number;
export declare const MIN_SQRT_PRICE_X64: BN;
export declare const MAX_SQRT_PRICE_X64: BN;
export declare const MIN_TICK_ARRAY_START_INDEX = -307200;
export declare const MAX_TICK_ARRAY_START_INDEX = 306600;
export declare const BIT_PRECISION = 14;
