...
class SwapMath {
    static swapCompute(programId, poolId, tickArrayCache, zeroForOne, fee, liquidity, currentTick, tickSpacing, currentSqrtPriceX64, amountSpecified, lastSavedTickArrayStartIndex, sqrtPriceLimitX64) {
        ...
        try {
            const { tickArrayAddress, tickArrayStartTickIndex: tickAarrayStartIndex } = tickQuery_1.TickQuery.nextInitializedTickArray(programId, poolId, tickArrayCache, state.tick, tickSpacing, zeroForOne);
            if (lastSavedTickArrayStartIndex !== tickAarrayStartIndex &&
                tickArrayAddress) {
                state.accounts.push(tickArrayAddress);
                lastSavedTickArrayStartIndex = tickAarrayStartIndex;
