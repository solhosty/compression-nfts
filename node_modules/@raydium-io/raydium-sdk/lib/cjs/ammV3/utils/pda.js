...
exports.getPdaOperationAccount = exports.getPdaMetadataKey = exports.getPdaPersonalPositionAddress = exports.getPdaProtocolPositionAddress = exports.getPdaTickArrayAddress = exports.getPdaPoolRewardVaulId = exports.getPdaPoolVaultId = exports.getPdaPoolId = exports.getPdaAmmConfigId = exports.OPERATION_SEED = exports.TICK_ARRAY_SEED = exports.POSITION_SEED = exports.POOL_REWARD_VAULT_SEED = exports.POOL_VAULT_SEED = exports.POOL_SEED = exports.AMM_CONFIG_SEED = void 0;
...
function getPdaProtocolPositionAddress(programId, poolId, tickLower, tickUpper) {
    return (0, common_1.findProgramAddress)([
        exports.POSITION_SEED,
        poolId.toBuffer(),
        (0, util_1.i32ToBytes)(tickLower),
        (0, util_1.i32ToBytes)(tickUpper),
    ], programId);
}
